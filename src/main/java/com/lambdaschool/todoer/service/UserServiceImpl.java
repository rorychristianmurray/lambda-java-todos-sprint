...
import com.lambdaschool.todoer.model.UserRoles;
import com.lambdaschool.todoer.repository.RoleRepository;
import com.lambdaschool.todoer.repository.UserRepository;
        ...
        if (currentUser != null)
        {
            if (id == currentUser.getUserid())
            {
                ...
                if (user.getUserRoles().size() > 0)
                {
                    ...
                    // add the new roles as they come in
                    for (UserRoles ur : user.getUserRoles())
                    {
